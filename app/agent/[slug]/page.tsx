...
// The variant comes from the profile and nothing else. The earlier
// ?variant=rental preview override was removed 3 Sept 2026 once demo-sales and
// demo-rental became real accounts: it never reached the email routes, so the
// page said rental while every email said sales.
